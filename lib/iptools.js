...
$hx_exports["iptools"] = $hx_exports["iptools"] || {};
...
class iptools_IPTools {
	...
	registerMyMethods() {
		let bus = this.maglev;
		this.maglev.register("IPTools.SubnetMaskToCIDR",maglev_MagLevFunction.fromFunction(function(args) {
			...
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'IPTools.SubnetMaskToCIDR' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("IPTools.CalcCIDR",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("IPTools.CalcCIDR"));
			data.push(maglev_MagLevString.fromString("iptools"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'IPTools.CalcCIDR' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("IPTools.IPToDecimal",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("IPTools.IPToDecimal"));
			data.push(maglev_MagLevString.fromString("iptools"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'IPTools.IPToDecimal' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("IPTools.IP4FromDecimal",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("IPTools.IP4FromDecimal"));
			data.push(maglev_MagLevString.fromString("iptools"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'IPTools.IP4FromDecimal' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("IPTools.IP6FromDecimal",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("IPTools.IP6FromDecimal"));
			data.push(maglev_MagLevString.fromString("iptools"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'IPTools.IP6FromDecimal' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("IPTools.IPv4ToIPv6",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("IPTools.IPv4ToIPv6"));
			data.push(maglev_MagLevString.fromString("iptools"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'IPTools.IPv4ToIPv6' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("IPTools.ExpandIPv6",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("IPTools.ExpandIPv6"));
			data.push(maglev_MagLevString.fromString("iptools"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'IPTools.ExpandIPv6' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("IPTools.CompressIPv6",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("IPTools.CompressIPv6"));
			data.push(maglev_MagLevString.fromString("iptools"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'IPTools.CompressIPv6' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
	}
}
$hxClasses["iptools.IPTools"] = $hx_exports["iptools"]["IPTools"] = iptools_IPTools;
iptools_IPTools.__name__ = "iptools.IPTools";
Object.assign(iptools_IPTools.prototype, {
	__class__: iptools_IPTools
	,maglev: null
});
class js_Boot {
	static isClass(o) {
...
var iptools = $hx_exports["iptools"];
